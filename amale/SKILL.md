...
5. After every material outcome, persist the decision, artifact, task transition or check. `html` generates the current human-facing progress view. Never rely on conversation memory or a final summary as the only checkpoint.
