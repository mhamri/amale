...
import { canonicalUrl, SHARE_IMAGE_ALT, SHARE_IMAGE_URL, SITE_NAME, TWITTER_HANDLE } from '../lib/seo';
...
export default function PageMeta(props: PageMetaProps) {
  ...
  return (
    <>
      ...
      <Meta property="og:image:width" content={String(SHARE_IMAGE.size)} />
      <Meta property="og:image:height" content={String(SHARE_IMAGE.size)} />
